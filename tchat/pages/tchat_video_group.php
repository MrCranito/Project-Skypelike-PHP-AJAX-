...
<h2 class="header header-form" value="Bonjour ">Bonjour vous etes en communication video sur le groupe <?php echo $_GET['user']?> </h2>
  ...
  <body onload="showMyFace()">
    ...
    <video id="firend2Video"></video>
  	<video id="friend3Video"></video>
    <br />
